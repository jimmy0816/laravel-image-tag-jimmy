    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="/">Start Sifar</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        {{link_to('newposts/create','Add', $attributes = array(), $secure = null)}}
                    </li>                      
                    <li class="page-scroll">
                        {{link_to('newposts','ImageList', $attributes = array(), $secure = null)}}
                    </li>                     
                    <li class="page-scroll">
                        {{link_to('newposts/tags','TagList', $attributes = array(), $secure = null)}}
                    </li>                                        
<!--                     <li class="page-scroll">
